...
/// <summary>Réponse d'un access token (login réussi, refresh) — calé sur le contrat de l'API.</summary>
public sealed record AccessTokenResponse(string AccessToken, System.DateTimeOffset AccessTokenExpiresAt);
