...
namespace Atlas.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260601204110_AddFeedItemFetchedAtIndex")]
    partial class AddFeedItemFetchedAtIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Atlas.Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("_passwordResetTokenExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("password_reset_token_expires_at");

                    b.Property<string>("_passwordResetTokenHash")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
            ...
            modelBuilder.Entity("Atlas.Domain.Veille.VeillePackLike", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("VeillePackId")
                        .HasColumnType("uuid")
                        .HasColumnName("veille_pack_id");

                    b.HasKey("Id");

                    b.HasIndex("VeillePackId");

                    b.HasIndex("UserId", "VeillePackId")
                        .IsUnique();

                    b.ToTable("veille_pack_like", (string)null);
                });

            modelBuilder.Entity("Atlas.Domain.Veille.VeillePackReport", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("VeillePackId", "Status");

                    b.HasIndex("ReporterUserId", "VeillePackId", "Status");

                    b.ToTable("veille_pack_report", (string)null);
                });
            ...
            modelBuilder.Entity("Atlas.Domain.Users.User", b =>
                {
                    b.OwnsOne("Atlas.Domain.Users.UserAccessibilityPreferences", "AccessibilityPreferences", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");

                            b1.Property<string>("FontPreference")
                                .IsRequired()
                                .ValueGeneratedOnAdd()
                                .HasMaxLength(32)
                                .HasColumnType("character varying(32)")
            ...
            modelBuilder.Entity("Atlas.Domain.Veille.VeillePackLike", b =>
                {
                    ...
                    b.HasOne("Atlas.Domain.Veille.VeillePack", null)
                        .WithMany()
                        .HasForeignKey("VeillePackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
