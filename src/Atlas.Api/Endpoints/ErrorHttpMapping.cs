...
internal static class ErrorHttpMapping
{
    ...
    private static int StatusCodeFor(string code) => code switch
    {
        ...
        "veille.feed_rule_not_found" => StatusCodes.Status404NotFound,
        "veille.veille_pack_not_public" => StatusCodes.Status404NotFound,
        ...
        "veille.veille_pack_immutable" => StatusCodes.Status409Conflict,
        "veille.veille_pack_code_already_used" => StatusCodes.Status409Conflict,
        "veille.source_blocked" => StatusCodes.Status403Forbidden,
        "veille.feed_rule_forbidden" => StatusCodes.Status403Forbidden,
        "veille.veille_pack_forbidden" => StatusCodes.Status403Forbidden,
        ...
        "favorites.trademark_already_favorite" => StatusCodes.Status409Conflict,
        "favorites.trademark_not_favorite" => StatusCodes.Status404NotFound,
        "favorites.invalid_deposit_number" => StatusCodes.Status400BadRequest,
        "favorites.patent_already_favorite" => StatusCodes.Status409Conflict,
        "favorites.patent_not_favorite" => StatusCodes.Status404NotFound,
        "favorites.invalid_publication_number" => StatusCodes.Status400BadRequest,
