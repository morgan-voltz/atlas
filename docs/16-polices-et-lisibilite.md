...
- **Emplacement** : dans **Profil → « Affichage & données »** (doc 12 §9), aux côtés du thème, de la densité et des autres préférences d'accessibilité. Un seul endroit « comment je vois l'app ».
