...
désormais derrière un challenge Cloudflare. L'**accès API PI du compte** (Marques / Brevets /
Dessins et modèles), actif en mai, **n'apparaît plus comme accordé** → **nouvelle demande d'accès
API PI à l'INPI** (détail dans F-006). Les autres 🟡 : clients MAUI compilés non QA (F-009/F-010), contenu légal UI
